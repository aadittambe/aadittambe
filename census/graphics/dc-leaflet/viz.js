...
var geojsonLayer = new L.geoJson(dcData, { onEachFeature: onEachFeature, style: style });
...
totalLegend.onAdd = function (map) {
    var div = L.DomUtil.create('div', 'info legend'),
        grades = [34, 30, 26, 22, 18, 14, 10, 6, 2],
        labels = [];
...
whiteLegend.onAdd = function (map) {
    var div = L.DomUtil.create('div', 'info legend'),
        grades = [25, 20, 15, 10, 5, -5, -10, -15, -20, -25],
        labels = [];
...
blackLegend.onAdd = function (map) {
    var div = L.DomUtil.create('div', 'info legend'),
        grades = [-45, -35, -25, -15, -5, 5, 15, 25, 35, 45],
        labels = [];
...
asianLegend.onAdd = function (map) {
    var div = L.DomUtil.create('div', 'info legend'),
        grades = [95, 85, 75, 65, 55, 45, 35, 25, 15],
        labels = [];
...
otherLegend.onAdd = function (map) {
    var div = L.DomUtil.create('div', 'info legend'),
        grades = [600, 550, 500, 450, 400, 350, 300, 250, 200],
        labels = [];
...
$('#select1').change(function () {
    ...
    if (this.value == "Total") {
        ...
        geojsonLayer = new L.geoJson(dcData, { onEachFeature: onEachFeature2, style: styleTotal });
        geojsonLayer.addTo(map);
        ...
        map.removeLayer(geojsonLayer);
        geojsonLayer = new L.geoJson(dcData, { onEachFeature: onEachFeature2, style: styleWhite });
        geojsonLayer.addTo(map);
        ...
        map.removeLayer(geojsonLayer);
        geojsonLayer = new L.geoJson(dcData, { onEachFeature: onEachFeature2, style: styleBlack });
        geojsonLayer.addTo(map);
        ...
        map.removeLayer(geojsonLayer);
        geojsonLayer = new L.geoJson(dcData, { onEachFeature: onEachFeature2, style: styleHispanic });
        geojsonLayer.addTo(map);
        ...
        map.removeLayer(geojsonLayer);
        geojsonLayer = new L.geoJson(dcData, { onEachFeature: onEachFeature2, style: styleAmericanIndian });
        geojsonLayer.addTo(map);
        ...
        map.removeLayer(geojsonLayer);
        geojsonLayer = new L.geoJson(dcData, { onEachFeature: onEachFeature2, style: styleAsian });
        geojsonLayer.addTo(map);
        ...
        map.removeLayer(geojsonLayer);
        geojsonLayer = new L.geoJson(dcData, { onEachFeature: onEachFeature2, style: stylePacific });
        geojsonLayer.addTo(map);
        ...
        map.removeLayer(geojsonLayer);
        geojsonLayer = new L.geoJson(dcData, { onEachFeature: onEachFeature2, style: styleOther });
        geojsonLayer.addTo(map);
        ...
        map.removeLayer(geojsonLayer);
        geojsonLayer = new L.geoJson(dcData, { onEachFeature: onEachFeature2, style: styleTwo });
        geojsonLayer.addTo(map);
